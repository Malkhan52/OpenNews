		...
		?>
			...
			<div class="row">
				<div class="col-lg-8">
						<?php $this->load->helper('url'); ?>
						<img src="<?php echo base_url('images/international_article.jpg'); ?>"></img>
				</div>
					<div class="col-lg-4">
						<h3>Other popular Articles</h3>
						<?php $this->load->helper('url'); ?>
						<img src="<?php echo base_url('images/international_article_1.jpg'); ?>"></img><br/><br/>
...
//            $data['mopennews'] = $this->mopennews->getRows(array('id'=>$this->session->userdata('userId')));
           ...
           $this->load->view('opennews_article_login_comment_page');
			...
			<div class="col-lg-3">
			<?php $this->load->helper('url'); ?>
						<img src="<?php echo base_url('images/international_article_2.jpg'); ?>"></img>
...
<?php $this->load->helper('url'); ?>
			...
			<div class="col-lg-3">
					<?php $this->load->helper('url'); ?>
						<img src="<?php echo base_url('images/international_article_2.jpg'); ?>"></img><br/>
					<p><b><?php $this->load->helper('url');
		echo anchor('copennews/international','National');?> | </b><?php $this->load->helper('url');
