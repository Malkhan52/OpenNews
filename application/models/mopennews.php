<?php
	...
	class Mopennews extends CI_Model{
...
//	}
    ...
    function add_vote_user($rating){
        $this->db->from('users_vote'); //table
        $this->db->where('rateing_id',$rating);
        $this->db->set('votes', 'votes+1', FALSE);
        $this->db->update('users_vote'); 
    }

     function getVotes()
    {
        $this->db->select("*");
        $this->db->from('users_vote');
